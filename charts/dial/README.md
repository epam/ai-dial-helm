...
![Version: 5.1.0](https://img.shields.io/badge/Version-5.1.0-informational?style=flat-square) ![AppVersion: 1.22.0](https://img.shields.io/badge/AppVersion-1.22.0-informational?style=flat-square)
...
| openai.image.tag | string | `"0.20.0"` |  |
...
| vertexai.image.tag | string | `"0.17.0"` |  |
