...
![Version: 5.11.0](https://img.shields.io/badge/Version-5.11.0-informational?style=flat-square) ![AppVersion: 1.31.0](https://img.shields.io/badge/AppVersion-1.31.0-informational?style=flat-square)
...
| bedrock.image.tag | string | `"0.30.0"` |  |
...
| openai.image.tag | string | `"0.28.0"` |  |
...
| vertexai.image.tag | string | `"0.24.0"` |  |
