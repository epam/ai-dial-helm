...
![Version: 4.2.0](https://img.shields.io/badge/Version-4.2.0-informational?style=flat-square) ![AppVersion: 1.20.0](https://img.shields.io/badge/AppVersion-1.20.0-informational?style=flat-square)
...
| bedrock.image.tag | string | `"0.20.0"` |  |
...
| openai.image.tag | string | `"0.18.0"` |  |
...
| vertexai.image.tag | string | `"0.14.0"` |  |
