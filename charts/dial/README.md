...
![Version: 3.1.0](https://img.shields.io/badge/Version-3.1.0-informational?style=flat-square) ![AppVersion: 1.15.0](https://img.shields.io/badge/AppVersion-1.15.0-informational?style=flat-square)
...
| bedrock.image.tag | string | `"0.14.0"` |  |
...
| openai.image.tag | string | `"0.14.0"` |  |
...
| vertexai.image.tag | string | `"0.10.0"` |  |
