...
| configuration.encryption.password | string | `""` | Random string used to encrypt sensitive data e.g. `pwgen -s 32 1` WARNING: Autogenerated if not set during first installation WARNING: Do not change after first installation |
| configuration.encryption.salt | string | `""` | Random string used to encrypt sensitive data e.g. `pwgen -s 32 1` WARNING: Autogenerated if not set during first installation WARNING: Do not change after first installation |
