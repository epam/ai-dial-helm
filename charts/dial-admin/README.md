...
| backend.image.tag | string | `"0.21.0"` | Image tag (immutable tags are recommended) |
...
| frontend.image.tag | string | `"0.21.0"` | Frontend image tag |
...
| manager.image.tag | string | `"0.21.0"` | Image tag (immutable tags are recommended) |
