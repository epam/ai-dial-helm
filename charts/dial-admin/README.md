...
![Version: 0.5.1](https://img.shields.io/badge/Version-0.5.1-informational?style=flat-square) ![AppVersion: 0.11.0](https://img.shields.io/badge/AppVersion-0.11.0-informational?style=flat-square) 
...
| backend.image.tag | string | `"0.11.0"` | Image tag (immutable tags are recommended) |
