...
![Version: 0.4.6](https://img.shields.io/badge/Version-0.4.6-informational?style=flat-square) ![AppVersion: 0.4.0](https://img.shields.io/badge/AppVersion-0.4.0-informational?style=flat-square) 
...
| backend.image.tag | string | `"0.9.0"` | Image tag (immutable tags are recommended) |
...
| frontend.image.tag | string | `"0.9.0"` | Frontend image tag |
