...
![Version: 0.13.0](https://img.shields.io/badge/Version-0.13.0-informational?style=flat-square) ![AppVersion: 0.16.0](https://img.shields.io/badge/AppVersion-0.16.0-informational?style=flat-square)
...
| backend.image.tag | string | `"0.16.0"` | Image tag (immutable tags are recommended) |
...
| frontend.image.tag | string | `"0.16.0"` | Frontend image tag |
...
| manager.image.tag | string | `"0.16.0"` | Image tag (immutable tags are recommended) |
